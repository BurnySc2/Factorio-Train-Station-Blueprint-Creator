import { botChestTypes, type defaultSettings } from "../constants/constants"
...
export const createNormalStation = (bpSettings: typeof defaultSettings): iBlueprintItem[] => {
	...
	if (bpSettings.madzuriEvenLoadUnload) {
		...
		madzuriRightArithmetic = placeMadzuriArithmeticCombinator(bpSettings, "Right", rightChests, rightOuterInserters)
		madzuriLeftArithmetic = placeMadzuriArithmeticCombinator(bpSettings, "Left", leftChests, leftOuterInserters)
	...
	rightSideItems = [...rightSideItems, ...rightPoles, ...rightChests, ...rightOuterInserters, ...madzuriRightArithmetic]
	leftSideItems = [...leftSideItems, ...leftPoles, ...leftChests, ...leftOuterInserters, ...madzuriLeftArithmetic]
	...
	stationItems = [...stationItems, ...mixSides(bpSettings.beltSidesUsed, leftSideItems, rightSideItems)]
	...
	if (bpSettings.beltFlowDirection !== "None") {
		...
		allItems = [...allItems, ...mixSides(bpSettings.beltSidesUsed, leftVerticalBelts, rightVerticalBelts)]
	}
