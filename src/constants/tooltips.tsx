const TOOLTIPS = {
	...
	includeTrainInBlueprint: "If enabled, adds the train with the expected layout to the blueprint.",
	enableFilterInserters: "If enabled, turns all inserters to filters inserters of equivalent level.",
	chestType:
	...
	connectBothSideWithGreenWire: "If enabled, connects the top left and top right chest / storage tank with green wire.",
	connectChestsWithRedWire:
		"If enabled, connects all chests on the left and all chests / storage tanks on the right together with green wire.",
	connectBothSideWithRedWire: "If enabled, connects the top left and top right chest / storage tank with red wire.",
