...
import type { iChestTypes, iSectionsProps } from "../../constants/interfaces"
	...
	return (
		<div className={CLASSES.section}>
			<div className={CLASSES.gridSection}>
				...
				/>
				<label className={CLASSES.labelElement} hidden={!canRequestFromBufferChests} htmlFor={"requestFromBuffers"}>
